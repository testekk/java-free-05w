...
public class ChivtkTicketManagement {
    ...
    public void sortByArriveDate() {
        ...
        tickets.sort(Comparator.comparing(ChivtkTicket::getArrivalDate));
    }
    ...
    public static void main(String[] args) {
        ...
        ChivtkTicket ticket1 = new ChivtkEconomyTicket("T001", 1000000, 123, "P001",
                ...
                "Dinner", "S001");
        // Convention: ecoTicket; businessTicket; firstClassTicket
        ...
        // Tìm vé theo mã
        ChivtkTicket foundTicket = ticketManagement.searchTicketById("T111");
        if (foundTicket == null) {      // Nếu không tìm thấy vé
            System.out.println("VDebug==> Không tìm thấy vé máy bay");
        } else {                        // Nếu tìm thấy vé
            System.out.println("Thông tin vé máy bay " + foundTicket.getId() + " vừa tìm kiếm");
